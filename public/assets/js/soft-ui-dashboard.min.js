...
function setAttributes(t, n) { Object.keys(n).forEach(function(e) { t.setAttribute(e, n[e]) }) }
...
function navbarBlurOnScroll(e) {
    ...
    function l() { t.classList.add(...a), t.classList.remove(...i), r("blur") }

    function o() { t.classList.remove(...a), t.classList.add(...i), r("transparent") }
    ...
    } : function() { o() }, 10), -1 < navigator.platform.indexOf("Win") && (n = document.querySelector(".main-content"), "true" == e ? n.addEventListener("ps-scroll-y", debounce(function() {
        (5 < n.scrollTop ? l : o)()
    }, 10)) : n.addEventListener("ps-scroll-y", debounce(function() { o() }, 10)))
}
...
function debounce(a, i, l) {
    ...
    return function() {
        var e = this,
            t = arguments,
            n = l && !o;
        clearTimeout(o), o = setTimeout(function() { o = null, l || a.apply(e, t) }, i), n && a.apply(e, t)
    }
}
...
function toggleSidenav() {
    body.classList.contains(className) ? (body.classList.remove(className),
        setTimeout(function() { sidenav.classList.remove("bg-white") },
            100),
...
var soft = {
    ...
    showSwal: function (e) {
        if ("basic" == e) Swal.fire("Any fool can use a computer");
            ...
            a.fire({ title: "Are you sure?", text: "You won't be able to revert this!", icon: "warning", showCancelButton: !0, confirmButtonText: "Yes, delete it!" }).then(e => { e.isConfirmed && Swal.fire("Deleted!", "Your file has been deleted.", "success") })
