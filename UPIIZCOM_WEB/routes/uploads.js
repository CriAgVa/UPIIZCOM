...
router.post('/', function(req, res){
   ...
   const uploadFolder ='E:\\NewStuff\\Escuela\\8vo Semestre\\Ejercicios\\Espiral5_v4\\UPIIZCOM\\UPIIZCOM_WEB\\public\\assets\\img\\general';
   form.multiples = true;
...
router.get('/downloadCHAT/:id', function(req, res){
    Archivo.findOne({nombreOriginal : req.params.id},
        function(err, reslt){
            ...
            var file = 'E://NewStuff//Escuela//8vo Semestre//Ejercicios//Espiral5_v4//UPIIZCOM//UPIIZCOM_WEB//public//assets//img//general//'+reslt.nombreNuevo;
            res.download(file)
